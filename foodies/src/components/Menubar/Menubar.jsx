...
const Menubar = () => {
   ...
   //Toggling focus of menubar comp(Home, explore, contactUs)
      ...
      <div className="d-flex align-items-center gap-4">
       <Link to='/cart'> <div className="position-relative">
        ...
        </div></Link>
        {
          ...
          :
          <>
          <button className='btn btn-outline-primary' onClick={()=>navigate('/myorders')}>MyOrders</button>
          <div className="dropdown text-end ">
            <a href="" className="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="flase">

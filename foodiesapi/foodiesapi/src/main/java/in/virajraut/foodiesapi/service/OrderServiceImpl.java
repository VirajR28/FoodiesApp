...
import in.virajraut.foodiesapi.entity.OrderEntity;
...
import in.virajraut.foodiesapi.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse createOrderWithPayment(OrderRequest request) throws RazorpayException {
        ...
        orderRequest.put("amount", newOrder.getAmount()*100); //Was storing 3.00 in razorpay gateway, to make it 300, multiplying with 100
